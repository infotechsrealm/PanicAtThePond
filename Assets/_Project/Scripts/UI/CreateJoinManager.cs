...
public class CreateJoinManager : MonoBehaviourPunCallbacks
{
    ...
    [SerializeField] private CoustomeRoomManager coustomeRoomManager;
    ...
    [SerializeField] private GameObject GameMode_Dropdown_Client;
    ...
    [SerializeField] private Toggle LAN;
            ...
            case "Join":
                {
                    ...
                    GameMode_Dropdown_Client.GetComponent<Dropdown>().interactable = false;
                    break;
                }
