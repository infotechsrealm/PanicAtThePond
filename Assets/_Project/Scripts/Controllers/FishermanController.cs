...
public class FishermanController : MonoBehaviourPunCallbacks, IPunInstantiateMagicCallback
{
    ...
    [SerializeField] private NetworkTransformUnreliable networkTransformUnreliable;
    ...
    [SerializeField] private AudioSource cricketChirping;
    public AudioSource fisherManSounds;
    [SerializeField] private AudioSource boatMoveSound;

    [SerializeField] private AudioClip throwWorm;
    public AudioClip stopBoat;

    [SerializeField] private int catchadeFishID;
