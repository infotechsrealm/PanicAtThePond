...
for part in parts:
    try:
        sheet_img.alpha_composite(Image.open(part).convert("RGBA"))
    except:
        pass
...
# PATHS
ui_dir = r"E:\PanicAtThePond\Assets\UI\Game UI\Fisherman\BoatFacingLeft"
new_ui_dir = r"E:\PanicAtThePond\Assets\UI\Game UI\Fisherman\BoatFacingLeft (Red Hair)"
...
print("Generating extra missing sprites...")
...
print(f"Generated {len(png_files)} extra sprites.")

# Now update the animations in DefaultAnimations (Red Hair)
target_anim_dir = r"E:\PanicAtThePond\Assets\Animations\Fisher Man Animations\DefaultAnimations (Red Hair)"
anim_files = glob.glob(os.path.join(target_anim_dir, "*.anim"))

print("Patching animations...")
